package com.monkey.common.factory;
...
public class SystemFactory {
	...
	protected static final Logger LOG = LoggerFactory.getLogger(SystemFactory.class);
	...
	public static SystemFactory getInstance(){
		if(instance == null){
			return new SystemFactory(31l,31l);
		}
		return instance;
	}
	/**
     ...
     *            序列号
     */
    public SystemFactory(long workerId, long datacenterId) {
	...
	public static void main(String[] args) {
		SystemFactory idWorker = new SystemFactory(31, 31);
		System.out.println("idWorker=" + idWorker.nextId());
		SystemFactory id = new SystemFactory();
