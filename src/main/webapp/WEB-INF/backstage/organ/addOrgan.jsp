                     ...
                     <div class="body-nest" id="basic">
                         <div class="form_center">
                             <form role="form">
                                 ...
                                 <div class="form-group">
                                     <label>备注</label>
                                     <textarea name="remark" style="height:200px!important;margin:20px 0" class="form-control" rows="3"></textarea>
                                 </div>
                                 <button class="btn btn-info" type="button" onclick="post('/organ/add')">
